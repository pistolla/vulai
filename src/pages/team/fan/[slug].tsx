...
function ShimmerStatCard() {
  return (
    <div className="text-center p-6 rounded-lg team-accent text-white animate-pulse">
...
function ShimmerMerchCard() {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden merch-item transition-all duration-300 animate-pulse">
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 animate-pulse">
      ...
      <div className="flex space-x-3">
        <div className="h-8 bg-gray-200 rounded w-24 flex-1"></div>
        <div className="h-8 bg-gray-200 rounded w-20"></div>
      </div>
    </div>
  );
        ...
        <div className="lg:pr-80"> {/* Add padding for sidebar on large screens */}
          ...
          <section className="team-theme py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4">{teamData?.name || 'Loading Team...'}</h1>
              <p className="text-xl">{teamData?.sport || 'Loading...'} Team - {teamData?.league || 'Loading...'}</p>
            </div>
          </section>
          ...
          <section className="py-12 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
                {teamData?.players ? teamData.players.map((player: any, index: number) => (
                      ...
                      <div className="flex space-x-3">
                        {user ? (
                          ...
                          <button
                            ...
                            className="block text-center bg-blue-600 text-white py-2 rounded hover:bg-blue-700 flex-1"
                          >
