    ...
    <FanGuard>
      ...
      <div className="relative">
        ...
        <div className="fixed top-0 right-0 h-full z-40">
          {/* Desktop Sidebar */}
          <div className="hidden lg:block w-80 h-full bg-white shadow-lg border-l border-gray-200">
            <div className="p-6">
              <h2 className="text-2xl font-bold mb-6 team-text">Live Fan Chat</h2>
              <div className="h-96 overflow-y-auto mb-4 border border-gray-300 rounded p-4">
          ...
          <div className="lg:hidden">
            ...
            {isChatOpen && (
              <div className="fixed bottom-20 right-6 w-80 h-96 bg-white rounded-lg shadow-xl border border-gray-200 z-40">
                <div className="p-4 border-b border-gray-200 flex justify-between items-center">
                  <h3 className="text-lg font-semibold team-text">Live Fan Chat</h3>
                  <button
                ...
                <div className="p-4 border-t border-gray-200">
                  <form onSubmit={sendChat} className="flex space-x-2">
                    <input value={chatMsg} onChange={e => setChatMsg(e.target.value)} type="text" placeholder="Type your message..." className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" />
                    <button type="submit" className="team-theme text-white px-4 py-2 rounded-md hover:opacity-90 text-sm">Send</button>
                  </form>
                </div>
              </div>
            )}
